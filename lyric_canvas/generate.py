...
def parse_args():
    ...
    parser.add_argument(
        "--api_key_1", type=str, default="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"
    )

    parser.add_argument(
        "--api_key_2", type=str, default="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"
    )
