#!/bin/bash
#SBATCH --job-name=gpt2-large                 # Job name
...
srun  --ntasks-per-node=9 python training_ml.py --ml 1 --batch_size 25 --learning_rate 5e-5 --model_name gpt2-large --context_length 1 --load_checkpoint -1
