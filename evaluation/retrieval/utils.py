...
def generate_images(pipe, prompt_dict, ds_id, saving_path, batch_size, size, num_images, gpu):
    added_prompt = "best quality, HD, 32K, high focus, dramatic lighting, ultra-realistic, high detailed photography, vivid, vibrant,intricate"
    ...
    for i in range(num_images):
        ...
        batch = []
        ids = []
        for num, (metaphor, prompt_info) in enumerate(prompt_dict.items()):
            p_id = prompt_info[0]
            prompt = prompt_info[1]
