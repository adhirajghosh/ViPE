...
def parse_args():
    ...
    parser.add_argument(
        "--data_set_dir_ml", type=str, default='/mnt/lustre/lensch/lhr027/datasets/genuis_chatgpt/lyrics_to_prompts.csv',
    ...
    parser.add_argument(
        "--check_path_ml", type=str, default='/mnt/lustre/lensch/lhr027/checkpoints/songanimator/',
    ...
    parser.add_argument(
        "--load_checkpoint", type=int, default=-1, help='which checkpoint version to load if resume training'
    )
